    ...
    //                x++;
            ...
            if(choice==4){
                ...
                while(1){
                    ...
                    vector<string> DeadlineVec; //Storing previous deadlines in the vector
                    int TaskId=0;
                    while(getline(f,name,'\n')&&
                        ...
                        DeadlineVec.push_back(deadline); //Storing Previous Deadlines in the vector
                    }
                    while(1){
                        cout<<endl<<"Do you want to update the deadline (y/n) ? : ";
                        char answ;
                        answ=getch();
                        if(answ=='n'){
                            break;
                            ...
                            cout<<left<<setw(1.5*nameWidth) << setfill(separator) <<DeadlineVec[selection-1]<<endl;
//                            int newStatus;
//                            cin>>newStatus;
//                            if(newStatus>=100){
//                                newStatus=100;
//                            }
                            ...
                            DeadlineVec.at(selection-1)=TrackStatus[selection-1].Deadline(leftDeadline);
                        }
                        cout<<endl;
                    }
                    ...
                    cout<<left<<setw(0.75*nameWidth) << setfill(separator) <<"Priority";
                    cout<<left<<setw(1.5*nameWidth) << setfill(separator) <<"Status";
                    cout<<left<<setw(0.50*nameWidth) << setfill(separator) <<"Deadline"<<endl;
                    cout<<"==========================================="<<endl;
                    ...
                    for(int i=0;i<TrackStatus.size();i++){
                        ...
                        cout<<left<<setw(0.50*nameWidth) << setfill(separator) <<DeadlineVec[i];
                        cout<<"  Added "<<TrackStatus[i].deadline<<" days to the deadline"<<endl;

                        ///Instead Using AssignTask Function try to write manually to the file
                        ///Open the file write manually
                        ...
                        fstream taskfile;
                        taskfile.open("TASK1.txt",std::ios_base::app);
                        taskfile<<TrackStatus[i].name<<endl;
                        taskfile<<TrackStatus[i].lastname<<endl;
                        taskfile<<TrackStatus[i].priority<<endl;
                        taskfile<<TrackStatus[i].task<<endl;
                        taskfile<<TrackStatus[i].getStatus(TrackStatus[i].status)<<endl;
                        taskfile<<DeadlineVec[i]<<endl<<endl;
                        taskfile.close();
            ...
            if(choice==4){
                ...
                while(1){
                    ...
                    while(getline(f,name,'\n')&&
                        ...
                        a.task=task;
                        TrackStatus.push_back(a);
                        DeadlineVec.push_back(deadline);
                    }
                    while(1){
                        ...
                        if(answ=='n'){
                            ...
                            TrackStatus[selection-1].deadline=leftDeadline;
                            DeadlineVec[selection-1]=TrackStatus[selection-1].Deadline(TrackStatus[selection-1].deadline);
                        }
                        cout<<endl;
                    }
